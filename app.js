setTimeout(function() {
    alert(
      "Welcome to Isiah's Space Battle page ! - open the console log on the page to play . Hurry the fate of the planet is at your fingertips Captian! If you chose to retreat at any time just leave the page. But know that choice has doomed Earth! "
    );
  }, 5000);
